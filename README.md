...
# Usage
## Options
Plugin options must be specified as a property of the plugin in the sqlc YAML configuration. 
```yaml
      - plugin: csharp
...
| externalConnection      | default: `true`<br/>values: `false`,`true`                                                                                                                                         | Yes      | Connection is passed to methods from caller, instead of being open in the method itself. This helps managing transactions spanning multiple methods.                                                                                                                                                                                        |
